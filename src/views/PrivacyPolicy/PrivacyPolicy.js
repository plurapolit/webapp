...
const PrivacyPolicy = () => (
  <div className={styles["wrapper"]}>
    <ContentWrapper>
      ...
      <br />
      <br />
      <p>I. Name und Kontaktdaten Verantwortlicher und Datenschutzbeauftragter</p>
      ...
      <br />
      <p>Der Datenschutzbeauftragte der PluraPolit gUG ist Robin Zuscke. Er ist unter robin@plurapolit.de für Anfragen erreichbar.</p>
      <br />
      <p>II. Art und Weise der Verarbeitung personenbezogener Daten sowie Art und Zweck von deren Verwendung</p>
      ...
      <p>Beim Aufrufen unserer Website www.plurapolit.de werden durch den auf Ihrem Endgerät zum Einsatz kommenden Browser automatisch Informationen an den Server unserer Website gesendet. Diese Informationen werden temporär in einem sog. Logfile gespeichert. Folgende Informationen werden dabei ohne Ihr Zutun erfasst und bis zur automatisierten Löschung gespeichert:</p>
      ...
      <p>· E-Mail Adresse</p>
      <p>Wir speichern zusätzlich den Hashwert eines von dem/der User*in einzugebenden Passworte. Aus dem Hashwert kann das jeweilige Original-Passwort nicht wiederhergestellt werden.</p>
      <br />
      <p>Wir veröffentlichen Ihren ersten Vornamen sowie Ihren Nachnamen sowie die gewählte Altersgruppe. Die E-Mail Adresse wird dabei nicht veröffentlicht.</p>
      <br />
      ...
      <p>Für einige Funktionalitäten unserer Website sind Cookies notwendig, so z.B. für das Speichern des Hashwertes eines Passwortes und der personalisierten Einstellungen auf unserer Website. Hier ist der Einsatz gem. Art. 6 Abs. 1 S. 1 lit. b DSGVO gerechtfertigt, um die von Ihnen gewünschte Funktion ordnungsgemäß erfüllen zu können. Es bedarf zum Einsatz dieser Cookies nicht Ihrer Einwilligung.</p>
      <br />
      <p>bb) Analysetool von Matomo (ehemals PIWIK)</p>
      <p>Wir nutzen auf unserer Website das Open-Source-Software-Tool Matomo (ehemals PIWIK) zur Analyse Ihres Surfverhaltens. Dabei wird ein Cookie auf Ihrem Rechner gesetzt. Die Software läuft ausschließlich auf den Servern unserer Webseite. Eine Speicherung Ihrer personenbezogenen Daten findet nicht statt, da infolge Aktivierung der Anonymisierung lediglich zwei Bytes Ihrer IP-Adresse gespeichert werden. Eine Zuordnung der gekürzten IP-Adresse zum aufrufenden Rechner ist dadurch nicht mehr möglich Eine Weitergabe der Daten an Dritte erfolgt ebenfalls nicht. Nähere Informationen erhalten Sie unter https://matomo.org/docs/privacy/</p>
      ...
      <br />
      <p>Außerdem können Sie Cookies von Drittanbietern deaktivieren, indem sie die Deaktivierungsseite der Netzwerkwerbeinitiative (Network Advertising Initiative) unter https://www.networkadvertising.org/choices/ aufrufen und die dort genannten weiterführenden Information zum Opt-Out umsetzen.</p>
      <br />
      ...
      <p>für die Weitergabe nach Art. 6 Abs. 1 S. 1 lit. c DSGVO eine gesetzliche Verpflichtung besteht und/oder</p>
      ...
      <br />
      <p>Wir greifen zwecks Hostings und Verteilung der Webseiteninhalte auf die Produkte „S3“ und „Cloudfront“ von Amazon Web Services, Inc., 410 Terry Avenue North, Seattle WA 98109, USA, („AWS“) zurück, der unsere Daten im Auftrag verarbeitet. Das Hosting erfolgt dabei ausschließlich im AWS-Rechenzentrum in Frankfurt a.M. AWS ist ferner Privacy-Shield-zertifiziert und garantiert damit, auch außerhalb des europäischen Wirtschaftsraums die personenbezogenen Daten entsprechend europäischer Datenschutzgesetze zu verarbeiten (https://www.privacyshield.gov/participant?id=a2zt0000000TOWQAA4&status=Active).</p>
      <br />
      ...
      <p>Möchten Sie von Ihrem Widerrufs- oder Widerspruchsrecht Gebrauch machen, genügt eine E-Mail an: datenschutz@plurapolit.de.</p>
      <br />
      ...
      <p>Durch die Weiterentwicklung unserer Website und Angebote darüber oder aufgrund geänderter gesetzlicher beziehungsweise behördlicher Vorgaben kann es notwendig werden, diese Datenschutzerklärung zu ändern. Die jeweils aktuelle Datenschutzerklärung kann jederzeit auf der Website unter www.plurapolit.de/datenschutz von Ihnen abgerufen und ausgedruckt werden.</p>
